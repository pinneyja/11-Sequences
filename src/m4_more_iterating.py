...
def run_test_count_positive_sines():
    ...
    expected = 2  # Trust me!
    actual = count_positive_sines([-1, 1, -2, 2])
    print()
    print('Test 10 expected:', expected)
    print('        actual:  ', actual)

    # TO DO 6 (continued):  Add your 1 ADDITIONAL test here:
    # Test 11 (using the list [0, 1, 2, ... 1065]
    sequence.append(1065)

    expected = 3
    actual = count_positive_sines([0, 1, 2, 3])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 1
    actual = sum_first_n([0, 0, 0, 1, 5, 8], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
